...
/********************
  이미지를 출력한다.
*********************/
void IMAGE :: PutChar( INT X, INT Y )
{
...
/**************************************
  이미지를 일정 배율 늘려서 출력한다.
***************************************/
void IMAGE :: PutCharStretch( INT X, INT Y, INT tWidth, INT tHeight )
{
    int i, j, t;
    ...
    for( i = 0; i < tHeight; i ++ ){
      ...
      for( j = 0; j < tWidth; j ++ ){
        ...
        if( pixel != _TransColor ) *ScrPtr = pixel;
        ScrPtr ++;
        xx += dx;
      }
...
/**************************************
  이미지를 일정 배율 늘려서 출력한다.
***************************************/
void IMAGE :: PutCharScale( INT X, INT Y, FIXED Scale )
{
